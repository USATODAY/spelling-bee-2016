...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/2016/05/spelling-bee/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/2016/05/spelling-bee/': 'style/project.css'
        }
      },
      upload3: {
        files: {
          //'/17200/experiments/usatoday/2016/05/spelling-bee/': 'data/*.json'
        }
      }
    },
  ...
  grunt.registerTask('build', ['clean:dev', 'jst', 'jshint', 'requirejs:deploy', 'sass:build', 'autoprefixer:build', 'copy:main', 'clean:tmp', 'copy:deploy',]);
